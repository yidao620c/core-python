...
参数：
1. src_base_dir     源码基础路径：E:\projects\guns\src\main\java
2. domain_package   domain类的包名：com.stylefeng.guns.common.persistence.model
3. mapper_package   mapper类的包名：com.stylefeng.guns.common.persistence.dao
4. xml_dir          mapper xml绝对路径：E:\projects\guns\src\main\java\com\stylefeng\guns\common\persistence\dao\mapping
5. schema_name      schema sql文件的绝对路径：E:\projects\epay-rest-api\src\main\resources\schema.sql
6. author           源代码的作者：熊能
"""
import sys
import os
